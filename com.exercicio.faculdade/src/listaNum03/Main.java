...
public class Main {
    public static void main(String[] args) {
        ...
        secretaria.setNumeroRamal("Rama3456");
        ...
        for (Funcionario funcionario : listaFuncionarios) {
            if (funcionario instanceof Gerente) {
                ...
                if (gerenteExistente.getLogin().equals("Pedro123")) {
                    gerenteExistente.setSalario(4600.0);
                    System.out.println("Salário do Gerente alterado para 4600.0");
                }
            }
        }
